...
// embedded AVR ISP for modchip (ATTINY85)

// Attiny external setup:
// FX chip select pin must inactive (pulled up)

// ISP reset pin (connected to Arduboy reset pin)
#define ISP_RESET_PORT PORTB
#define ISP_RESET_DDR  DDRB
#define ISP_RESET_BIT  4
// ISP SPI port (connected to Arduboy)
#define ISP_SPI_PORT   PORTB
#define ISP_SPI_DDR    DDRB
#define ISP_SPI_PIN    PINB
#define ISP_SCK_BIT    2
#define ISP_MISO_BIT   1
#define ISP_MOSI_BIT   0
...
#define ISP_PAGE_SIZE           0x40 // Page size in program WORDs for atmega32u4
...
#define ISP_EXTFUSE_MASK        0xC0 // Atmega32u4 undefined/reserved bits
#define ISP_LOCKBITS_MASK       0xC0 // Atmega32u4 undefined/reserved bits
